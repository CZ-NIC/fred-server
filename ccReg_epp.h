...
bool ccReg_EPP_i::TestDatabaseConnect();
  ...
  ccReg::Response* ClientLogin(const char* ClID, const char* passwd, const char* newpass, const char* clTRID, CORBA::Long& clientID , const char* certID ,  const char* lang );
