...
public:
  ...
  ccReg::Response* ClientLogin(const char* ClID, const char* passwd, const char* newpass, const char* clTRID, CORBA::Long& clientID , const char* certID , ccReg::lang language );
  ...
  ccReg::Response* DomainTransfer(const char* fqdn, /* const char* registrant, */ const char* authInfo, CORBA::Long clientID, const char* clTRID , const ccReg::ExtensionList& ext );
