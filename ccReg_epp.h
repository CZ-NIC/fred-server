...
public:
  ...
  ccReg::Response* ContactCheck(const char* handle, CORBA::Boolean& avail, CORBA::Long clientID, const char* clTRID);
  ...
  ccReg::Response* HostCheck(const char* name, CORBA::Boolean& avail, CORBA::Long clientID, const char* clTRID);
  ...
  ccReg::Response* NSSetCheck(const char* handle, CORBA::Boolean& avail, CORBA::Long clientID, const char* clTRID);
  ...
  ccReg::Response* DomainCheck(const char* fqdn, CORBA::Boolean& avail, CORBA::Long clientID, const char* clTRID);
