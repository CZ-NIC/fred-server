...
BOOST_AUTO_TEST_CASE(registrar_outzone_no_debt)
{
    ...
    ::LibFred::Registrar::Registrar::AutoPtr registrar = createTestRegistrarClassNoCz(varsym);

    ::LibFred::Banking::PaymentImpl payment;
...
BOOST_AUTO_TEST_CASE(registrar_outzone_exactly)
{
    ...
    ::LibFred::Credit::init_new_registrar_credit(registrar->getId(), zone_id);
