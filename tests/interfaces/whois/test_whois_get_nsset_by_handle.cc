...
: whois_impl_instance_fixture
{
    ...
    : test_nsset_handle("TEST-NSSET-HANDLE"),
      ...
      nsset(
          Test::exec(
              Test::CreateX_factory<Fred::CreateNsset>().make(registrar.handle, test_nsset_handle)
...
BOOST_FIXTURE_TEST_CASE(get_nsset_by_handle, get_nsset_by_handle_fixture)
{
    ...
    BOOST_CHECK(nss.tech_contact_handles.at(0) == nsset.tech_contacts.at(0).handle);
}
