...
: whois_impl_instance_fixture
{
    ...
    : registrar(
          Test::exec(Test::CreateX_factory<Fred::CreateRegistrar>().make(), ctx)), //Test::registrar::make
      keyset(
          Test::exec(
              Test::CreateX_factory<Fred::CreateKeyset>().make(registrar.handle)
                  ...
                  .set_tech_contacts(Util::vector_of<std::string>(Test::contact::make(ctx).handle)),//(Test::contact::make(ctx).handle))
              ctx)),
