...
public:
    ...
    void exec(Fred::OperationContext& ctx, const Fred::InfoContactOutput& contact)
    {
        ...
        //error handling
        if(/*unknown ssntype*/true)
            static_cast<DERIVED*>(this)->ex.set_unknown_ssntype("some_unknown_ssntype_to_be_reported");
...
class UpdateContactById : public UpdateContact<UpdateContactById>
{
