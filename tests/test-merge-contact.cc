    ...
    , virtual merge_contact_n_domain_admin_fixture
{
    ...
    void test_impl()
    {
        ...
        for(int i = 0; i < domain_owner_count; ++i)
        {
            info_domain_owner_1.push_back(Fred::InfoDomain(merge_contact_n_domain_owner_fixture::get_handle(i)).exec(ctx));
        }
        ...
        for(int i = 0; i < domain_owner_count; ++i)
        {
            info_domain_owner_2.push_back(Fred::InfoDomain(merge_contact_n_domain_owner_fixture::get_handle(i)).exec(ctx));
        }
        ...
        for(int i = 0; i < domain_admin_count; ++i)
        {
            info_domain_admin_2.push_back(Fred::InfoDomain(merge_contact_n_domain_admin_fixture::get_handle(i)).exec(ctx));
        }
...
{
    //info before merge
    Fred::InfoDomainOut info_domain_owner_1 = Fred::InfoDomain(test_domain_owner_handle).exec(ctx);
    Fred::InfoDomainOut info_domain_admin_1 = Fred::InfoDomain(test_domain_admin_handle).exec(ctx);
    ...
    //info after merge
    Fred::InfoDomainOut info_domain_owner_2 = Fred::InfoDomain(test_domain_owner_handle).exec(ctx);
    Fred::InfoDomainOut info_domain_admin_2 = Fred::InfoDomain(test_domain_admin_handle).exec(ctx);
