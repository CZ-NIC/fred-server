    ...
    , virtual merge_contact_n_domain_admin_fixture
{
    ...
    void test_impl()
    {
        ...
        for(int i = 0; i < keyset_count; ++i)
        {
            info_keyset_1.push_back(Fred::InfoKeyset(merge_contact_n_keyset_fixture::get_handle(i)).exec(ctx));
        }

        std::vector<Fred::InfoDomainOut> info_domain_owner_1;
        info_domain_owner_1.reserve(domain_owner_count);
        for(int i = 0; i < domain_owner_count; ++i)
        {
            info_domain_owner_1.push_back(Fred::OldInfoDomain(merge_contact_n_domain_owner_fixture::get_handle(i)).exec(ctx));
        }

        std::vector<Fred::InfoDomainOut> info_domain_admin_1;
        info_domain_admin_1.reserve(domain_admin_count);
        for(int i = 0; i < domain_admin_count; ++i)
        {
            info_domain_admin_1.push_back(Fred::OldInfoDomain(merge_contact_n_domain_admin_fixture::get_handle(i)).exec(ctx));
        }
        ...
        for(int i = 0; i < keyset_count; ++i)
        {
            info_keyset_2.push_back(Fred::InfoKeyset(merge_contact_n_keyset_fixture::get_handle(i)).exec(ctx));
        }

        std::vector<Fred::InfoDomainOut> info_domain_owner_2;
        info_domain_owner_2.reserve(domain_owner_count);
        for(int i = 0; i < domain_owner_count; ++i)
        {
            info_domain_owner_2.push_back(Fred::OldInfoDomain(merge_contact_n_domain_owner_fixture::get_handle(i)).exec(ctx));
        }

        std::vector<Fred::InfoDomainOut> info_domain_admin_2;
        info_domain_admin_2.reserve(domain_admin_count);
        for(int i = 0; i < domain_admin_count; ++i)
        {
            info_domain_admin_2.push_back(Fred::OldInfoDomain(merge_contact_n_domain_admin_fixture::get_handle(i)).exec(ctx));
        }
        ...
        for(int i = 0; i < domain_owner_count; ++i)
        {
            Fred::InfoDomainOut info_domain_owner_with_change = info_domain_owner_1.at(i);
        ...
        for(int i = 0; i < domain_admin_count; ++i)
        {
            Fred::InfoDomainOut info_domain_admin_with_change = info_domain_admin_1.at(i);
...
{
    //info before merge
    Fred::InfoDomainOut info_domain_owner_1 = Fred::OldInfoDomain(test_domain_owner_handle).exec(ctx);
    Fred::InfoDomainOut info_domain_admin_1 = Fred::OldInfoDomain(test_domain_admin_handle).exec(ctx);
    ...
    //info after merge
    Fred::InfoDomainOut info_domain_owner_2 = Fred::OldInfoDomain(test_domain_owner_handle).exec(ctx);
    Fred::InfoDomainOut info_domain_admin_2 = Fred::OldInfoDomain(test_domain_admin_handle).exec(ctx);
    Fred::InfoKeysetOutput info_keyset_2 = Fred::InfoKeyset(test_keyset_handle).exec(ctx);
    Fred::InfoNssetOutput info_nsset_2 = Fred::InfoNsset(test_nsset_handle).exec(ctx);

    //compare state before merge with state after
    Fred::InfoDomainOut info_domain_owner_with_change = info_domain_owner_1;
    info_domain_owner_with_change.info_domain_data.registrant_handle = dst_contact_handle;
    ...
    Fred::InfoDomainOut info_domain_admin_with_change = info_domain_admin_1;
    info_domain_admin_with_change.info_domain_data.admin_contacts = Util::vector_of<std::string>(dst_contact_handle);
