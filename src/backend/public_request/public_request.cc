...
std::map<std::string, unsigned char> get_public_request_type_to_post_type_dictionary()
{
    ...
    if (dictionary.insert(
                std::make_pair(Type::Authinfo::get_iface_of<Type::Authinfo::Post>()
                               .get_public_request_type(), 1)).second &&
        dictionary.insert(
                std::make_pair(Type::Blockunblock::get_iface_of<Type::Blockunblock::BlockTransferPost>()
                               .get_public_request_type(), 2)).second &&
        dictionary.insert(
                std::make_pair(Type::Blockunblock::get_iface_of<Type::Blockunblock::UnblockTransferPost>()
                               .get_public_request_type(), 3)).second &&
        dictionary.insert(
                std::make_pair(Type::Blockunblock::get_iface_of<Type::Blockunblock::BlockChangesPost>()
                               .get_public_request_type(), 4)).second &&
        dictionary.insert(
                std::make_pair(Type::Blockunblock::get_iface_of<Type::Blockunblock::UnblockChangesPost>()
                               .get_public_request_type(), 5)).second &&
        dictionary.insert(
                std::make_pair(Type::Personalinfo::get_iface_of<Type::Personalinfo::Post>()
    ...
    try
    {
        ...
        unsigned long long public_request_id;
        {
            ...
            public_request_id = LibFred::CreatePublicRequest(
                ...
                .exec(locked_object, Type::Authinfo::get_iface_of<Type::Authinfo::Auto>(), log_request_id);
        ...
        switch (confirmation_method)
        {
            case ConfirmedBy::email:
            {
                const unsigned long long request_id =
                    create_public_request_op.exec(locked_object, Type::Authinfo::get_iface_of<Type::Authinfo::Email>(), log_request_id);
                ctx.commit_transaction();
                return request_id;
            }
            ...
            {
                const unsigned long long request_id =
                    create_public_request_op.exec(locked_object, Type::Authinfo::get_iface_of<Type::Authinfo::Post>(), log_request_id);
                ctx.commit_transaction();
                return request_id;
            }
        }
        ...
        std::shared_ptr<LibFred::Mailer::Manager> manager) const
{
    ...
    try
    {
        ...
        const auto public_request_id = LibFred::CreatePublicRequest()
            .exec(locked_object, Type::Personalinfo::get_iface_of<Type::Personalinfo::Auto>(), log_request_id);
        LibFred::UpdatePublicRequest()
        ...
        const std::string& specified_email) const
{
    ...
    try
    {
        ...
        switch (confirmation_method)
        {
            ...
            {
                const unsigned long long request_id =
                    create_public_request_op.exec(locked_object, Type::Personalinfo::get_iface_of<Type::Personalinfo::Email>(), log_request_id);
                ctx.commit_transaction();
                return request_id;
            }
            case ConfirmedBy::letter:
            {
                const unsigned long long request_id =
                    create_public_request_op.exec(locked_object, Type::Personalinfo::get_iface_of<Type::Personalinfo::Post>(), log_request_id);
                ctx.commit_transaction();
                return request_id;
            }
        }
