        ...
        const NotificationData& _notification_data)
{
    ...
    {
        LibFred::OperationContextCreator ctx;
        ctx.get_log().info(std::string("transfer_domain_localized: ") + e.what());
    ...
    {
        LibFred::OperationContextCreator ctx;
        ctx.get_log().info(std::string("transfer_domain_localized failure: ") + e.what());
        throw EppResponseFailureLocalized(
                ctx,
    ...
    {
        LibFred::OperationContextCreator ctx;
        ctx.get_log().info("unexpected exception in transfer_domain_localized function");
        throw EppResponseFailureLocalized(
                ctx,
                EppResponseFailure(EppResultFailure(EppResultCode::command_failed)),
                _session_data.lang);
