...
void set_ContactUpdate_discloseflag(LibFred::UpdateContactByHandle& update_op, bool value);

template < >
void set_ContactUpdate_discloseflag<ContactDisclose::Item::name>(LibFred::UpdateContactByHandle& update_op, bool value)
{
    update_op.set_disclosename(value);
}

template < >
void set_ContactUpdate_discloseflag<ContactDisclose::Item::organization>(LibFred::UpdateContactByHandle& update_op, bool value)
{
    update_op.set_discloseorganization(value);
}

template < >
void set_ContactUpdate_discloseflag<ContactDisclose::Item::address>(LibFred::UpdateContactByHandle& update_op, bool value)
{
    update_op.set_discloseaddress(value);
}

template < >
void set_ContactUpdate_discloseflag<ContactDisclose::Item::telephone>(LibFred::UpdateContactByHandle& update_op, bool value)
{
    update_op.set_disclosetelephone(value);
}

template < >
void set_ContactUpdate_discloseflag<ContactDisclose::Item::fax>(LibFred::UpdateContactByHandle& update_op, bool value)
{
    update_op.set_disclosefax(value);
}

template < >
void set_ContactUpdate_discloseflag<ContactDisclose::Item::email>(LibFred::UpdateContactByHandle& update_op, bool value)
{
    update_op.set_discloseemail(value);
}

template < >
void set_ContactUpdate_discloseflag<ContactDisclose::Item::vat>(LibFred::UpdateContactByHandle& update_op, bool value)
{
    update_op.set_disclosevat(value);
}

template < >
void set_ContactUpdate_discloseflag<ContactDisclose::Item::ident>(LibFred::UpdateContactByHandle& update_op, bool value)
{
    update_op.set_discloseident(value);
}

template < >
void set_ContactUpdate_discloseflag<ContactDisclose::Item::notify_email>(LibFred::UpdateContactByHandle& update_op, bool value)
{
    update_op.set_disclosenotifyemail(value);
}

template < ContactDisclose::Item::Enum ITEM >
void set_ContactUpdate_discloseflag(const ContactDisclose& disclose, LibFred::UpdateContactByHandle& update_op)
{
...
LibFred::InfoContactData info_contact_by_handle(const std::string& handle, LibFred::OperationContext& ctx)
{
    try
    {
        ...
        const SessionData& session_data)
{
    ...
    const LibFred::InfoContactData contact_data_before_update = info_contact_by_handle(contact_handle, ctx);
    ...
    {
        const LibFred::ObjectStatesInfo contact_states_before_update(LibFred::GetObjectStates(contact_data_before_update.id).exec(ctx));
    ...
    // update itself
    {
        ...
        set_ContactUpdate_member(trimmed_change.name, update, &LibFred::UpdateContactByHandle::set_name);
        set_ContactUpdate_member(trimmed_change.organization, update, &LibFred::UpdateContactByHandle::set_organization);
        set_ContactUpdate_member(trimmed_change.telephone, update, &LibFred::UpdateContactByHandle::set_telephone);
        set_ContactUpdate_member(trimmed_change.fax, update, &LibFred::UpdateContactByHandle::set_fax);
        set_ContactUpdate_member(trimmed_change.email, update, &LibFred::UpdateContactByHandle::set_email);
        set_ContactUpdate_member(trimmed_change.notify_email, update, &LibFred::UpdateContactByHandle::set_notifyemail);
        set_ContactUpdate_member(trimmed_change.vat, update, &LibFred::UpdateContactByHandle::set_vat);
        set_ContactUpdate_member(trimmed_change.authinfopw, update, &LibFred::UpdateContactByHandle::set_authinfo);
