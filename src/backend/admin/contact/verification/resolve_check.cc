...
namespace Verification {
    ...
    void resolve_check::postprocess_manual_check(
        ...
        if( new_handle == LibFred::ContactCheckStatus::OK
            ...
            if(new_handle ==      LibFred::ContactCheckStatus::OK) { status.insert(   CONTACT_PASSED_MANUAL_VERIFICATION); }
            else if(new_handle == LibFred::ContactCheckStatus::FAIL) { status.insert( CONTACT_FAILED_MANUAL_VERIFICATION); }
