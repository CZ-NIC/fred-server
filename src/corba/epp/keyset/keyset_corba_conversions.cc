...
unwrap_ccReg_DNSKey_to_vector_Epp_Keyset_DnsKey(
...
void
wrap_Epp_InfoKeysetOutputData_DnsKeys(const Epp::Keyset::InfoKeysetOutputData::DnsKeys& _src, ccReg::DNSKey& _dst)
{
    _dst.length(_src.size());
    ::size_t idx = 0;
