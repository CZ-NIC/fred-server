...
#include "cfg/handle_administrativeblocking_args.h"


using namespace std;

const string server_name = "fred-abfd";
...
boost::assign::list_of
    ...
    (HandleArgsPtr(new HandleAdministrativeBlockingArgs));
...
int main(int argc, char *argv[])
{
    ...
    {   //config
        ...
        CorbaContainer::get_instance()
            ->register_server(new Registry::Administrative::Server_i(server_name)
            , "Administrative");
