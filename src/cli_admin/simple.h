...
#define addOptTID(name)                     (name, boost::program_options::value<Fred::TID>(), name##_DESC)
...
#define addOptTIDDef(name, val)           (name, boost::program_options::value<Fred::TID>()->default_value(val), name##_DESC)
