...
#define REGISTRAR_REGISTRAR_CREATE_CERTIFICATION_NAME_DESC  "create registrar certification"
#define REGISTRAR_REGISTRAR_CREATE_GROUP_NAME  "registrar_create_group"
#define REGISTRAR_REGISTRAR_CREATE_GROUP_NAME_DESC  "create registrar group"
#define REGISTRAR_REGISTRAR_INTO_GROUP_NAME  "registrar_into_group"
#define REGISTRAR_REGISTRAR_INTO_GROUP_NAME_DESC  "add registrar into group"
...
#define REGISTRAR_GROUP_NAME        "registrar_group"
#define REGISTRAR_GROUP_NAME_DESC   "registrar group name"
...
public:
        ...
        m_conf(conf)
    {
        ...
        if (!db->OpenDatabase(connstring.c_str()))
         {
            throw std::runtime_error("RegistrarClient db connection failed");
         }
