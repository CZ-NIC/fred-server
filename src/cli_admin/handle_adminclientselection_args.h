    ...
    get_options_description()
    {
        ...
        cfg_opts->add_options()
            ...
            ("price", boost::program_options
                ::value<Checked_string_fpnumber>()->notifier(save_arg_using_to_string<optional_string>(params.price))
                , "price")
            ("taxdate", boost::program_options
              ::value<Checked::string>()->notifier(save_optional_string(params.taxdate))
    ...
    get_options_description()
    {
        ...
        cfg_opts->add_options()
            ...
            ("operation_price", boost::program_options
                ::value<Checked_string_fpnumber>()->notifier(save_arg_using_to_string<optional_string>(params.operation_price))
