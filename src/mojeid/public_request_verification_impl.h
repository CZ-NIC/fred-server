...
const Type PRT_CONDITIONAL_MOJEID_CONTACT_IDENTIFICATION = "mojeid_contact_conditional_identification";
const Type PRT_MOJEID_CONTACT_IDENTIFICATION = "mojeid_contact_identification";
const Type PRT_MOJEID_CONTACT_IDENTIFICATION = "mojeid_contact_validation";
