...
}//namespace Registry::MojeIDImplData::Internal

inline void from_into(const Address &src, Fred::Contact::PlaceAddress &dst)
{
    Internal::common_conversion_into_fred(src, dst);
}

inline void from_into(const ShippingAddress &src, Fred::ContactAddress &dst)
{
    Internal::common_conversion_into_fred(src, dst);
...
inline void from_into(const Fred::Contact::PlaceAddress &src, Address &dst)
{
    Internal::common_conversion_from_fred(src, dst);
}

inline void from_into(const Fred::ContactAddress &src, ShippingAddress &dst)
{
    Internal::common_conversion_from_fred(src, dst);
...
inline void from_into(const CreateContact &src, Fred::InfoContactData &dst)
{
    Internal::common_conversion_into_fred(src, dst);
...
inline void from_into(const UpdateContact &src, Fred::InfoContactData &dst)
{
    Internal::common_conversion_into_fred(src, dst);
    dst.id        = src.id;
    dst.telephone = src.telephone;
...
inline void from_into(const SetContact &src, Fred::InfoContactData &dst)
{
    Internal::minimal_common_conversion_into_fred(src, dst);
    dst.telephone = src.telephone;
}

inline void from_into(const Fred::InfoContactData &src, CreateContact &dst)
{
    Internal::common_conversion_from_fred(src, dst);
...
inline void from_into(const Fred::InfoContactData &src, UpdateContact &dst)
{
    Internal::common_conversion_from_fred(src, dst);
    dst.id        = src.id;
    dst.telephone = src.telephone;
...
inline void from_into(const Fred::InfoContactData &src, SetContact &dst)
{
    Internal::minimal_common_conversion_from_fred(src, dst);
    if (!src.telephone.isnull()) {
        dst.telephone = src.telephone.get_value();
    }
}
