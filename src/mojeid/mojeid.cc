...
namespace Registry
{
    namespace MojeID
    {
        ...
        void MojeIDImpl::contactUnidentifyPrepare(
             ...
             , unsigned long long _request_id)
        {
            ...
            try {
                ...
                std::vector<std::string> drop_states
                    = Fred::states_conversion(drop_states_codes);
                ...
                for(std::vector<std::string>::const_iterator it
                    ...
                    if(Fred::ObjectState::CONDITIONALLY_IDENTIFIED_CONTACT == *it
                        ...
                        if(std::string("serverDeleteProhibited") == *it) {
                            ...
                            throw std::runtime_error(
                                "Programming error: discrepancy between SQL and processing code");
                        }
                    }
                }
        ...
        }//MojeIDImpl::contactUnidentifyPrepare
