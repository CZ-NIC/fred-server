#include "src/libfred/banking/bank_exporter.hh"
...
{
    TRACE("[CALL] LibFred::Banking::ExporterXML::doExport(Statement)");
...
{
    TRACE("[CALL] LibFred::Banking::ExporterXML::writeStatementItem()");
