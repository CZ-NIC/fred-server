#ifndef BANK_PAYMENT_LIST_IMPL_HH_44F1FE93A5364A109A5E98255827EC2E
#define BANK_PAYMENT_LIST_IMPL_HH_44F1FE93A5364A109A5E98255827EC2E
...
class PaymentListImpl : public LibFred::CommonListImplNew,
                        public PaymentList
{
public:
    ...
    {
        TRACE("[CALL] LibFred::Banking::ItemList::reload(Database::Filters::Union &)");
        clear();
        filter.clearQueries();
