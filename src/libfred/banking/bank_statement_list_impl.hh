#ifndef BANK_STATEMENT_LIST_IMPL_HH_54F0CFD4FE124644853DE49A104260B8
#define BANK_STATEMENT_LIST_IMPL_HH_54F0CFD4FE124644853DE49A104260B8
...
class StatementListImpl : public LibFred::CommonListImplNew,
...
public:
    ...
    {
        TRACE("[CALL] LibFred::Banking::StatementListImpl::reload(Database::Filters::Union &)");
        clear();
        filter.clearQueries();
