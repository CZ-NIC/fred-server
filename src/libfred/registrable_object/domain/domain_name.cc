...
DomainNameValidator& DomainNameValidator::set_ctx(LibFred::OperationContext& _ctx) {
    ctx_= &_ctx;
...
, public Util::FactoryAutoRegister<DomainNameChecker, DomainNameCheckerNotEmptyDomainName>
{
    ...
    const LibFred::OperationContext* ctx_ptr_;
public:
    ...
    void set_ctx(const LibFred::OperationContext& _ctx)
    {
        ctx_ptr_ = &_ctx;
    }
...
void insert_domain_name_checker_name_into_database(LibFred::OperationContext& ctx, const std::string& checker_name, const std::string& checker_description)
{
