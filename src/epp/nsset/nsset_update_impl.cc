    ...
    //lists check
    {
        ...
        //check dns hosts to add
        {
            ...
            for(std::size_t i = 0; i < _data.dns_hosts_add.size(); ++i)
            {
                ...
                if(!Fred::Domain::is_general_syntax_compliant_domain_name(_data.dns_hosts_add.at(i).fqdn))
                {
        ...
        //check dns hosts to remove
        {
            ...
            for(std::size_t i = 0; i < _data.dns_hosts_rem.size(); ++i)
            {
                ...
                if(!Fred::Domain::is_general_syntax_compliant_domain_name(_data.dns_hosts_rem.at(i).fqdn))
                {
