...
template <>
inline Epp::Nsset::StatusValue::Enum from_fred_object_state<Epp::Nsset::StatusValue>(Fred::Object_State::Enum value)
{
    switch (value)
    {
...
inline Fred::Object_State::Enum to_fred_object_state(Epp::Nsset::StatusValue::Enum value)
{
    switch (value)
    {
