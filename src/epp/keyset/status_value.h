...
#ifndef STATUS_VALUE_H_8DA30B84AACB4F6BB59FF181A946F237
#define STATUS_VALUE_H_8DA30B84AACB4F6BB59FF181A946F237
...
template <>
inline Epp::Keyset::StatusValue::Enum from_fred_object_state<Epp::Keyset::StatusValue>(Fred::Object_State::Enum value)
{
    switch (value)
    {
...
inline Fred::Object_State::Enum to_fred_object_state(Epp::Keyset::StatusValue::Enum value)
{
    switch (value)
    {
