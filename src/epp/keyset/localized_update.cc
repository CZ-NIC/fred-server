    ...
    const std::string &_dont_notify_client_transaction_handles_with_this_prefix)
{
    try {
        ...
        insert_vector_parameter_error_if_presents(e, Param::keyset_dnskey_add, Reason::duplicated_dnskey, errors);
        ...
        insert_vector_parameter_error_if_presents(e, Param::keyset_dnskey_rem, Reason::duplicated_dnskey, errors);
