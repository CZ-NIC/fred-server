...
public:
    ...
    get_options_description()
    {
        ...
        opts_descs->add_options()
                ...
                ("registry.authinfo_registrar",
                 boost::program_options::value<std::string>()->required(),
                 "handle of registrar which stores object authinfos generated by public requests");
    ...
    void handle(int _argc, char* _argv[], FakedArgs &_fa)
    {
        ...
        authinfo_registrar = vm["registry.authinfo_registrar"].as<std::string>();
    }
...
public:
    ...
    const std::string& get_authinfo_registrar()const
    {
        return HandleRegistryArgs::authinfo_registrar;
    }
};
