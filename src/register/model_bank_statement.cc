...
std::string ModelBankStatement::table_name = "bank_head";
...
DEFINE_BASIC_FIELD(ModelBankStatement, Database::Money, balanceOld, m_balanceOld, table_name, "balance_old", )
DEFINE_BASIC_FIELD(ModelBankStatement, Database::Money, balanceNew, m_balanceNew, table_name, "balance_new", )
DEFINE_BASIC_FIELD(ModelBankStatement, Database::Money, balanceCredit, m_balanceCredit, table_name, "balance_credit", )
DEFINE_BASIC_FIELD(ModelBankStatement, Database::Money, balanceDebet, m_balanceDebet, table_name, "balance_debet", )
