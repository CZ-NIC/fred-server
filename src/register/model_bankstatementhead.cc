...
DEFINE_BASIC_FIELD(ModelBankStatementHead, unsigned long long, accountId, m_accountId, table_name, "account_id", .setForeignKey())
...
DEFINE_BASIC_FIELD(ModelBankStatementHead, unsigned long long, fileId, m_fileId, table_name, "file_id", .setForeignKey())
