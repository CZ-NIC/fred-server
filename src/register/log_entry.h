...
class LogEntry : virtual public Register::CommonObject {
public:
  virtual const Database::DateTime&  getTimeBegin() const = 0;
  virtual const Database::DateTime&  getTimeEnd() const = 0;
  virtual const Database::LogServiceType& getServiceType() const = 0;
...
public:
  virtual LogEntry* get(unsigned _idx) const = 0;
