...
DEFINE_BASIC_FIELD(ModelInvoice, unsigned long long, zoneId, m_zoneId, table_name, "zone", .setForeignKey())
...
DEFINE_BASIC_FIELD(ModelInvoice, unsigned long long, registrarId, m_registrarId, table_name, "registrarid", .setNotNull().setForeignKey())
...
DEFINE_BASIC_FIELD(ModelInvoice, unsigned long long, prefixTypeId, m_prefixTypeId, table_name, "prefix_type", .setNotNull().setForeignKey())
DEFINE_BASIC_FIELD(ModelInvoice, unsigned long long, fileId, m_fileId, table_name, "file", .setForeignKey() )
DEFINE_BASIC_FIELD(ModelInvoice, unsigned long long, fileXmlId, m_fileXmlId, table_name, "filexml",  .setForeignKey() )
