...
ccReg_Payments_i::ccReg_Payments_i(
        LibFred::Banking::PaymentList *list):
    list_(list)
{
}
...
ccReg_Payments_i::getRow(CORBA::UShort row)
{
    ...
    const LibFred::Banking::Payment *data = list_->get(row);
    if (!data) {
...
ccReg_Payments_i::sortByColumn(CORBA::Short column, CORBA::Boolean dir)
{
    ...
    switch (column) {
//        case 0:
//            list_->sort(LibFred::Banking::IMT_ID, dir);
//            break;
//        case 1:
//            list_->sort(LibFred::Banking::IMT_STATEMENT_ID, dir);
//            break;
        case 0:
            list_->sort(LibFred::Banking::IMT_ACCOUNT_NUMBER, dir);
            break;
        case 1:
            list_->sort(LibFred::Banking::IMT_BANK_CODE, dir);
            break;
//        case 4:
//            list_->sort(LibFred::Banking::IMT_TYPE, dir);
//            break;
//        case 5:
//            list_->sort(LibFred::Banking::IMT_CODE, dir);
//            break;
//        case 6:
//            list_->sort(LibFred::Banking::IMT_CONSTSYMB, dir);
//            break;
        case 2:
            list_->sort(LibFred::Banking::IMT_VARSYMB, dir);
            break;
//        case 8:
//            list_->sort(LibFred::Banking::IMT_SPECSYMB, dir);
//            break;
        case 3:
            list_->sort(LibFred::Banking::IMT_PRICE, dir);
            break;
//        case 10:
//            list_->sort(LibFred::Banking::IMT_ACCOUNT_EVID, dir);
//            break;
        case 4:
            list_->sort(LibFred::Banking::IMT_ACCOUNT_DATE, dir);
            break;
        case 5:
            list_->sort(LibFred::Banking::IMT_ACCOUNT_MEMO, dir);
            break;
        case 7:
            list_->sort(LibFred::Banking::IMT_ACCOUNT_NAME, dir);
            break;
        case 8:
            list_->sort(LibFred::Banking::IMT_CREATE_TIME, dir);
            break;
        case 9:
            list_->sort(LibFred::Banking::IMT_DEST_ACCOUNT, dir);
            break;
...
ccReg_Payments_i::saveFilter(const char *name)
{
    ...
    tmp_filter_manager->save(LibFred::Filter::FT_STATEMENTITEM, name, uf);
}

LibFred::Banking::Payment *
ccReg_Payments_i::findId(ccReg::TID id)
{
    Logging::Context ctx(base_context_);
    try {
        LibFred::Banking::Payment *data = list_->getById(id);
        if (data) {
            return data;
        }
        return 0;
