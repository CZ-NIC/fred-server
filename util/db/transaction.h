...
// 
//   
//   TSSTransaction_(connection_type &_conn) : conn_(_conn),
//                                          ptransaction_(0),
//                                          success_(false) {
//     if (!conn_.inTransaction()) {
// #ifdef HAVE_LOGGER
...
// 
// 
//   void setParentTransaction(TSSTransaction_<transaction_type, manager_type> *_trans) {
//     ptransaction_ = _trans;
// #ifdef HAVE_LOGGER
//     LOGGER(PACKAGE).debug(boost::format("(%1%) parent transaction assigned (%2%)") % this % ptransaction_);
// #endif
...
// 
// 
//   TSSTransaction_<transaction_type, manager_type>* getParentTransaction() const {
//     return ptransaction_;
//   }
// 
// 
// private:
//   connection_type                                 &conn_;
//   TSSTransaction_<transaction_type, manager_type> *ptransaction_;
//   transaction_type                                 transaction_;
//   bool                                             success_;
//   savepoint_list                                   savepoints_;
// };
